...
module.exports = {
	...
	entry: {
		admin: path.join(SRC_DIR, 'admin.app.js'),
		client: path.join(SRC_DIR, 'client.app.js')
	},
	...
	plugins: [
		...
		new EventHooksPlugin({
				...
				fs.writeFileSync(path.resolve(DIST_DIR, './assets.json'), JSON.stringify(assetCollection, null, 2));
			}
		})
	],
